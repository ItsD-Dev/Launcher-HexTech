...
class Home {
    ...
    async initNews() {
        ...
        if (this.news) {
                ...
                blockNews.innerHTML = `
                    <div class="news-header">
                        <div class="header-text">
                            <div class="title">Atualmente não há novidades disponíveis.</div>
                        </div>
                    </div>
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>Aqui você pudera seguir as novidades do servidor.</p>
                        </div>
                    </div>`
            ...
            blockNews.innerHTML = `
                ...
                <div class="news-content">
                    <div class="bbWrapper">
                        <p>Impossivel de aceder au servidor das novidades.</br>Verifique a sua configuraçao.</p>
                    </div>
                </div>`
            // news.appendChild(blockNews);
        }
    ...
    async initStatusServer() {
        ...
        if (!serverPing.error) {
            ...
            serverMs.innerHTML = `<span class="green">Online</span> - 1 ms`;
